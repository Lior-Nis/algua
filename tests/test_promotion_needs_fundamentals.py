...
def test_promotion_preflight_passes_fundamentals_pit_check(tmp_path):
    ...
    try:
        ...
        # past the (removed) PIT block and proceeds past family governance (#532 cold-start no
        # longer refused) and fails at the breadth gate (no recorded search breadth) — proving the
        # PIT block is gone.
