...
def test_knowledge_dir_default_and_override(monkeypatch):
    ...
    # The suite-wide conftest fixture redirects this to a tmp dir so no test writes into the real
    # vault; drop it here to observe the actual default.
    monkeypatch.delenv("ALGUA_KNOWLEDGE_DIR", raising=False)
