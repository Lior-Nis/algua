...
- **CODEOWNERS-protected files this slice touches:** `cli/paper_cmd.py`, `registry/transitions.py`, `cli/registry_cmd.py`. Expected and unavoidable; note it in the PR so human review is anticipated.
