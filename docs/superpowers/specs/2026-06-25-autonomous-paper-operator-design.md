...
> **Status (2026-07-04):** original design; PR #288 superseded. Implementation tracked under epic #318 — #316 (paper run-all), #317 (intake/allocate), plus follow-on issues for the research-cycle merge-back driver and the always-on systemd driver. Slices 4+5 (NOVEL-family autonomy) deferred, off the minimal unattended path.
